...
class Main extends PluginBase implements Listener {
	public function onLoad() {
		$this->getLogger()->info(TextFormat::AQUA . "MineBlock 플러그인을 로드하고 있습니다");
	}
	public function onEnable() {
		$this->getServer()->getPluginManager()->registerEvents($this, $this);
		$this->getLogger()->info(TextFormat::AQUA . "MineBlock 플러그인을 사용할 수 있습니다!");
	}
	...
	public function onDisable() {
		$this->getLogger()->info(TextFormat::DARK_AQUA . "MineBlock 플러그인을 비활성화 합니다");
	}
